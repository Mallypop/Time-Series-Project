...
library(TTR)
library(mgcv)
setwd("C:/Users/Mallypop/Desktop/LAST_VERSION/")
@
...
dest<-"C:/Users/Mallypop/Desktop/LAST_VERSION/run.txt"
...
\section{Modeling the time series}
...
The 0.2 are starting values for Phi, which are in the modeling process optimized.
...
\subsection{Modeling time series with ARIMA }
ARIMA modeling is a time efficient option to the gls(). 
