...
data:  x$residuals
Dickey-Fuller = -1.0665, Lag order = 8, p-value =
0.928
alternative hypothesis: stationary
...
data:  x$fitted
Dickey-Fuller = -89939817370, Lag order = 8, p-value
= 0.01
alternative hypothesis: stationary
...
data:  x$residuals
X-squared = 603.7779, df = 1, p-value < 2.2e-16\begin{figure}[H]
\begin{Schunk}
\begin{Sinput}
> par(mfrow=c(1,2))
> plot(datalm)
...
First good thing: ARIMA does not care about stationarity. If your dataset is non-stationary, it will make it stationary as good as possible. 
...
forecast.arima = forecast.Arima(autoarima, h=120) #f<fc>r 10 jahre #automatizing 10*period
